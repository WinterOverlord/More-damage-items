...
public class MoreDamageItemsModTabs {
	...
	public static final RegistryObject<CreativeModeTab> P = REGISTRY.register("p",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.more_damage_items.p")).icon(() -> new ItemStack(Blocks.GRASS_BLOCK)).displayItems((parameters, tabData) -> {
				...
				tabData.accept(MoreDamageItemsModItems.CYAN.get());
				tabData.accept(MoreDamageItemsModBlocks.CYAN_ORE.get().asItem());
				tabData.accept(MoreDamageItemsModBlocks.CYAN_BLOCK.get().asItem());
				tabData.accept(MoreDamageItemsModItems.CYAN_PICKAXE.get());
				tabData.accept(MoreDamageItemsModItems.CYAN_AXE.get());
				tabData.accept(MoreDamageItemsModItems.CYAN_SWORD.get());
				tabData.accept(MoreDamageItemsModItems.CYAN_SHOVEL.get());
				tabData.accept(MoreDamageItemsModItems.CYAN_HOE.get());
				tabData.accept(MoreDamageItemsModItems.CYAN_ARMOR_HELMET.get());
				tabData.accept(MoreDamageItemsModItems.CYAN_ARMOR_CHESTPLATE.get());
				tabData.accept(MoreDamageItemsModItems.CYAN_ARMOR_LEGGINGS.get());
				tabData.accept(MoreDamageItemsModItems.CYAN_ARMOR_BOOTS.get());
			}).withSearchBar().build());
